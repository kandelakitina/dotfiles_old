...
packadd minpac 			" MinPac package manager to load first
call minpac#init()

command! PackUpdate call minpac#update() 			" Update packs
command! PackClean call minpac#clean() 				" Clean deleted packs
